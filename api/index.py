...
application.add_handler(CommandHandler("start", usr_conv.start))
application.add_handler(CommandHandler("admin", adm_cb.admin_panel, filters=filters.ChatType.PRIVATE))

    # GRUP 1: Semua ConversationHandler (PENTING: didaftarkan sebelum handler individual)
application.add_handler(user_submission_conv)
application.add_handler(user_package_conv)
application.add_handler(admin_conv)

    # GRUP 2: Semua CallbackQueryHandler ADMIN yang individual (di luar percakapan)
application.add_handler(CallbackQueryHandler(adm_cb.admin_panel, pattern="^admin_back_main$"))
application.add_handler(CallbackQueryHandler(adm_cb.admin_menu_user, pattern="^admin_menu_user$"))
application.add_handler(CallbackQueryHandler(adm_cb.admin_stats, pattern="^admin_stats$"))
application.add_handler(CallbackQueryHandler(adm_cb.admin_menu_ban_unban, pattern="^admin_menu_ban_unban$"))
application.add_handler(CallbackQueryHandler(adm_cb.admin_choose_user_list, pattern=r"^admin_choose_user:"))
application.add_handler(CallbackQueryHandler(adm_cb.admin_user_management_menu, pattern=r"^admin_manage_user:"))
application.add_handler(CallbackQueryHandler(adm_cb.admin_info_user, pattern=r"^admin_info_user:"))
application.add_handler(CallbackQueryHandler(adm_cb.admin_edit_quota_menu, pattern=r"^admin_edit_quota_menu:"))
application.add_handler(CallbackQueryHandler(adm_cb.admin_choose_action_menu, pattern=r"^edit_type:"))
application.add_handler(CallbackQueryHandler(adm_cb.admin_confirm_action_callback, pattern=r"^admin_confirm_"))
application.add_handler(CallbackQueryHandler(adm_conv.admin_broadcast_confirm, pattern="^admin_broadcast_confirm$"))
application.add_handler(CallbackQueryHandler(adm_conv.admin_broadcast_cancel, pattern="^admin_broadcast_cancel$"))
application.add_handler(CallbackQueryHandler(adm_cb.confirm_payment_callback, pattern=r"^confirm_payment:"))
application.add_handler(CallbackQueryHandler(adm_cb.confirm_package_callback, pattern=r"^confirm_package:"))
application.add_handler(CallbackQueryHandler(adm_cb.admin_menu_submission_management, pattern="^admin_menu_submission$"))
application.add_handler(CallbackQueryHandler(adm_cb.admin_menu_settings, pattern="^admin_menu_settings$"))
application.add_handler(CallbackQueryHandler(adm_cb.admin_list_pending_submissions, pattern=r"^list_pending:"))
application.add_handler(CallbackQueryHandler(adm_cb.admin_view_pending_submission_detail, pattern=r"^view_pending:"))
application.add_handler(CallbackQueryHandler(adm_cb.admin_reject_submission, pattern=r"^reject_submission:"))
application.add_handler(CallbackQueryHandler(adm_cb.admin_list_editable_submissions, pattern=r"^list_editable:"))
application.add_handler(CallbackQueryHandler(adm_cb.admin_view_editable_submission_detail, pattern=r"^view_editable:"))
application.add_handler(CallbackQueryHandler(adm_cb.admin_list_active_posts, pattern=r"^list_active:"))
application.add_handler(CallbackQueryHandler(adm_cb.admin_confirm_delete_post, pattern=r"^confirm_delete:"))
application.add_handler(CallbackQueryHandler(adm_cb.admin_execute_delete_post, pattern=r"^execute_delete:"))
application.add_handler(CallbackQueryHandler(adm_cb.admin_toggle_maintenance_mode, pattern="^toggle_maintenance$"))
application.add_handler(CallbackQueryHandler(adm_cb.post_submission_callback, pattern=r"^post:")) # Cukup satu kali, yang ini untuk posting.

    # GRUP 3: Semua CallbackQueryHandler USER yang individual (di luar percakapan)
application.add_handler(CallbackQueryHandler(usr_cb.back_to_main_menu_callback, pattern="^back_to_main_menu$"))
application.add_handler(CallbackQueryHandler(usr_conv.view_packages_callback, pattern="^view_packages$"))
application.add_handler(CallbackQueryHandler(usr_conv.buy_package_callback, pattern=r"^buy_package:"))
application.add_handler(CallbackQueryHandler(usr_cb.lihat_riwayat_callback, pattern=r"^lihat_riwayat:"))
application.add_handler(CallbackQueryHandler(usr_cb.user_mark_sold_callback, pattern=r"^sold:"))
...
application.add_handler(CallbackQueryHandler(usr_cb.handle_unknown_callback, pattern=r"."))
